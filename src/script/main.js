...
window.onload = () => {
    setTimeout(() => {
        new CreateNode(GetElement.id('loadingScreen')).setAnimate([
            {
                duration: 1000,
                css: {
                    transition: '1s',
